...
const cskplayers = [{
    id: 1,
    name: "Virat-kohli",
    imageUrl: "https://www.cricbuzz.com/a/img/v1/75x75/i1/c170661/virat-kohli.jpg",
...
},
{
    ...
    imageUrl: "https://www.cricbuzz.com/a/img/v1/75x75/i1/c195763/devdutt-padikkal.jpg",
    ...
    imageUrl: "https://www.cricbuzz.com/a/img/v1/75x75/i1/c171035/washington-sundar.jpg",
    birthPlace: "Pretoria ",
...
},
{
    id: 4,
    name: "Glenn-maxwell",
    imageUrl: "https://www.cricbuzz.com/a/img/v1/75x75/i1/c170641/glenn-maxwell.jpg",
...
},
{
    id: 5,
    name: "Daniel-sams",
    imageUrl: "https://www.cricbuzz.com/a/img/v1/75x75/i1/c180315/daniel-sams.jpg",
    birthPlace: " Gujarat ",
...
},
{
    id: 6,
    name: "Ab-de-villiers",
    imageUrl: "https://www.cricbuzz.com/a/img/v1/75x75/i1/c170999/ab-de-villiers.jpg",
    birthPlace: "Trinidad",
...
},
{
    id: 7,
    name: "Finn-allen",
    imageUrl: "https://www.cricbuzz.com/a/img/v1/75x75/i1/c154585/finn-allen.jpg",
...
},
{
    id: 8,
    name: "Harshal-patel",
    imageUrl: "https://www.cricbuzz.com/a/img/v1/75x75/i1/c153415/harshal-patel.jpg",
...
},
{
    id: 9,
    name: "Adam-zampa",
    imageUrl: "https://www.cricbuzz.com/a/img/v1/75x75/i1/c170654/adam-zampa.jpg",
    birthPlace: "Hamilton",
    born:"Jan 31, 1997 (24 years)",
...
},
{
    id: 10,
    name: "Kyle-jamieson",
    imageUrl: "https://www.cricbuzz.com/a/img/v1/75x75/i1/c156101/kyle-jamieson.jpg",
    birthPlace: "England",
...
},
{
    ...
    imageUrl: "https://www.cricbuzz.com/a/img/v1/75x75/i1/c170638/kane-richardson.jpg",
    birthPlace: "Ranchi",
...
},
{
    id: 12,
    name: "Navdeep-saini",
    imageUrl: "https://www.cricbuzz.com/a/img/v1/75x75/i1/c178690/navdeep-saini.jpg",
    birthPlace: "Punjab",
...
},
{
    ...
    imageUrl: "https://www.cricbuzz.com/a/img/v1/75x75/i1/c170690/yuzvendra-chahal.jpg",
    birthPlace: "Uttar Pradesh",
...
const updateLS = (name,place,birth,role,battingstyle,bowlingstyle) => {
    ...
    var playerList = localStorage.getItem('rcb-p-list') === null ? [] : JSON.parse(localStorage.getItem('rcb-p-list'));
    playerList.push(obj);
    localStorage.setItem("rcb-p-list", JSON.stringify(playerList));
    loadDataLS();
...
function loadDataLS(){
    const playerDataGet = JSON.parse(localStorage.getItem("rcb-p-list"));
